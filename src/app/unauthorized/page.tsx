...
function UnauthorizedContent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[75vh] px-4">
      ...
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3"><Trans tKey="app.text" /></h1>
      ...
      {(module || action) && (
        <div className="bg-white dark:bg-card rounded-xl p-6 mb-10 w-full max-w-md text-center border shadow-sm">
          <p className="text-sm text-muted-foreground mb-3 font-medium tracking-wide uppercase"><Trans tKey="app.required_permission" /></p>
