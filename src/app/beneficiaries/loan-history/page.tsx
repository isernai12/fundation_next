  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-2 text-sm text-muted-foreground">
        ...
        <span className="font-medium text-foreground">Loan History</span>
      </div>

      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Loan History</h1>
          <p className="text-muted-foreground">Historical records of loans and repayments for the beneficiary.</p>
        </div>
        <BeneficiarySelector />
      </div>
      ...
      {!beneficiaryId ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center h-64 space-y-4">
            ...
            <p className="text-muted-foreground">Please select a beneficiary to view their loan history.</p>
          </CardContent>
        </Card>
      ) : (
        <Card>
          <CardContent className="flex flex-col items-center justify-center h-64 space-y-4 pt-6">
            ...
            <div className="text-xl font-semibold">No Loan Records</div>
            <p className="text-muted-foreground">This beneficiary has not taken any loans yet.</p>
          </CardContent>
        </Card>
      )}
    </div>
