...
INSERT INTO "new_Document" ("beneficiaryId", "categoryId", "createdAt", "createdBy", "description", "documentNumber", "entityId", "foundationId", "generatedFilename", "grantId", "id", "loanId", "memberId", "mimeType", "originalFilename", "remarks", "sizeBytes", "status", "targetType", "title", "type", "updatedAt", "updatedBy", "url") SELECT "beneficiaryId", "categoryId", "createdAt", "createdBy", "description", "documentNumber", "entityId", "foundationId", "generatedFilename", "grantId", "id", "loanId", "memberId", "mimeType", "originalFilename", "remarks", "sizeBytes", "status", "targetType", "title", "type", "updatedAt", "updatedBy", "url" FROM "Document";
DROP TABLE "Document";
